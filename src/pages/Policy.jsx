      ...
      <main className='policy-landpage'>
        ...
        <div className="policy-container">
          <div className="policy-text-container">
            ...
            <p>
              AtlasMarkets is glad to receive your comments concerning this "Privacy Policy". In case you think that AtlasMarkets does not follow the rules and violate this Statement, contact us at support@atlasmarkets.com We guarantee that we will take commercially reasonable efforts to discover and solve the problem.
            </p>
          </div>
        </div>
        <About />
