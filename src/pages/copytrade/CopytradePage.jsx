...
const CopytradePage = () => {
  ...
  return (
    <>
      <section className='mirrortrade-page-section'>
        <Header />
        <div className="mirrortrade-gap"></div>
        <div className='plan-section mirror-trade-plan-section'>
          <div className="videoframe-text-container" data-aos="fade-up">
            <h1> <span className="highlight">mirrortrade </span> plans</h1>
          ...
          <div className="plan-card-container mirror-trade-card-container">
            {
