    ...
    <main className='signup-page'>
      ...
      <div className="login-wrapper">
        <form className="form" onSubmit={(e) => {
          ...
          <img src="/signalsynch logo (3).png" alt="" className="signup-logo" onClick={() => {
            navigate('/')
          }} />
          <span className="subtitle">Get started with AtlasMarkets, just create an account and enjoy the best copytrading experience.</span>
